function [theta,M]=get_theta_exp(metodo_f,tipo_error_1,tipo_error_2)
%[theta,M]=get_theta_cos(get_theta_exp,tipo_error_1,tipo_error_2)
%
% Proporciona los valores theta de la función exponencial, ante errores de 
% tipo forward o backward, absolutos o relativos.
% 
% Datos de entrada:
...
switch tipo_error_1
    case 'forward'
        [theta,M]=get_theta_exp_forward(metodo_f,tipo_error_2);
    case 'backward'
        [theta,M]=get_theta_exp_backward(metodo_f,tipo_error_2); 
    otherwise
