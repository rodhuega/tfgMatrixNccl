...
fprintf('Theta values of relative forward errors for %s (nt=%d, nd=%d)\n',func2str(f),nt,nd);
for k=1:length(M)
    ef = series_relative_forward_error(f,M(k),nt);
    x=0;inc=1;2
    for i=1:nd
