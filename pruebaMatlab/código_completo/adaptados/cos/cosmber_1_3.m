function [fA,m,s,np] = cosmber_1_3(A)
% [fA,m,s,np] = cosmber_1_3(A)
%
% Cálculo del coseno matricial por Bernoulli mediante:
%   - 'terminos_pares_impares_polinomio_completo'.
%   - 'conEstNormaConPotencias'.
%
% Datos de entrada:
...
formulacion_seleccion_ms(1)=2;
formulacion_seleccion_ms(2)=4;
