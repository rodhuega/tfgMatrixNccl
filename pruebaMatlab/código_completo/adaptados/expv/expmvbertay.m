...
switch seleccion_ms
    case 1
        [fAv,m,s,np] = fun_pol('expv','taylor_bernoulli','conEstNorma','sinGPUs',A,v);
    case 2
        [fAv,m,s,np] = fun_pol('expv','taylor_bernoulli','conEstNormaSolo','sinGPUs',A,v);
    case 3
        [fAv,m,s,np] = fun_pol('expv','taylor_bernoulli','conEstNormaPotencias','sinGPUs',A,v);
end
