function [fAv,m,s,np] = expmvtay_inef(A,v,seleccion_ms)
...
switch seleccion_ms
    ...
    case 2
        [fA,m,s,np] = fun_pol('exp','taylor','conEstNormaSolo','sinGPUs',A);
    case 3
        [fA,m,s,np] = fun_pol('exp','taylor','conEstNormaPotencias','sinGPUs',A);
end
fAv=fA*v;