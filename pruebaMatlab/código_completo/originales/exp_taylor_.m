function [B,m,sm,npm]=exp_taylor(A,imax)
%[B,m,sm,npm]=exp_taylor(A,imax)
%Nueva versión del cálculo de m y s basado en potencias y en estimadores
...
%comentar líneas 57-58 y descomentar líneas 59-60
zeta=[
