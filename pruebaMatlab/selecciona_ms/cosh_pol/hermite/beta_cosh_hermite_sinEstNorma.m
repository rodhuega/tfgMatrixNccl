function Beta_min = beta_cosh_hermite_sinEstNorma(b,d,m,q)
% Beta_min = beta_cosh_hermite_sinEstNorma(b,d,m,q) 
...
%     error('beta_cos_hermite_sinEstNorma:NanInfEstimation',['Nan or inf appeared in bounding the norms of high matrix powers with products of the norms of known matrix powers, check matrix'])
% end
end