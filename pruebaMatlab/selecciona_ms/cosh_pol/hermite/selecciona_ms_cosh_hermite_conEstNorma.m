function [m,s,pB,nProd]=selecciona_ms_cosh_hermite_conEstNorma(plataforma,A)
...
error('selecciona_ms_cosh_hermite_conEstNorma:NoParam','Cannot find valid parameters, check matrix')
end
