function [m,s,pA,nProd]=selecciona_ms_expv_taylor_conEstNorma(plataforma,A,mmax)
...
%[m,s,P,nProd]=selecciona_ms_exp_taylor_conEstNorma2(plataforma,A,mmax);
[m,s,P,nProd]=selecciona_ms_exp_taylor_conEstNorma(plataforma,A,mmax);
pA{1}=A;
end
