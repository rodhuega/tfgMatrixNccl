function [m,s,pA,nProd]=selecciona_ms_expv_taylor_conEstNormaPotencias(plataforma,A,mmax)
...
[m,s,P,nProd]=selecciona_ms_exp_taylor_conEstNormaPotencias(plataforma,A,mmax);
pA{1}=A;
end
