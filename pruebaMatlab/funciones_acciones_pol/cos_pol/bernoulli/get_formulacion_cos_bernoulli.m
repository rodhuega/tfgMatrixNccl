function formulacion=get_formulacion_cos_bernoulli
% formulacion=get_formulacion_cos_bernoulli
%
% Obtiene el valor de la variable global que determina la formulación
...
formulacion=formulacion_cos_bernoulli;
