function gen_matrices_jordan_random_complex(F,n,bound_vp,max_mult,nmat,nd)
% gen_F_jordan_random_complex(F,n,bound_vp,max_mult,nmat,nd)
%
...
% y con una multiplicidad determinada. Por cada matriz se genera un 
% fichero.mat que almacena:
...
% gen_F_jordan_random_complex(@exp,128,10,5,100,256)

digits(nd);
t0=sprintf('%s_jordan_random_complex_n%d_boundvp%d_maxmult%d_nd%d',func2str(F),n,bound_vp,max_mult,nd);
try
    warning off
